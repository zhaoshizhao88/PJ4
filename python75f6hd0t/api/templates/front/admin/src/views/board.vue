<template>
	<div class="content" :style='{"alignContent":"flex-start","padding":"0 0 20px 0","overflow":"hidden","background":"rgb(17, 17, 17)","flexDirection":"column","display":"flex","width":"100%","position":"relative","height":"100%"}'>
		<div id="particles"></div>
		<div :style='{"padding":"24px 0 0","margin":"0 0 20px 0","background":"url(http://codegen.caihongy.cn/20250106/5bd33b9661bd4632a61f91ee3e87c0c6.png) no-repeat top center","display":"flex","width":"100%","position":"relative","justifyContent":"center","height":"96px","zIndex":"2"}'>
			<!-- 标题 -->
			<div :style='{"margin":"0","fontSize":"20px","color":"rgb(255, 255, 255)","textAlign":"center","fontWeight":"700"}'>欢迎使用 {{this.$project.projectName}}</div>
			<!-- 时间 -->
			<div :style='{"top":"45px","color":"rgb(34, 157, 255)","display":"inline-block","lineHeight":"44px","fontSize":"16px","position":"absolute","right":"2%","height":"44px"}'>{{ dates }} <span @click="backClick" style="cursor:pointer;padding: 0 0 0 8px;">管理界面</span></div>
		</div>
		<div :style='{"padding":"0 20px","flex":"auto","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"0","zIndex":"2"}'>
			<div :style='{"width":"25%","padding":"15px","flexDirection":"column","background":"url(http://codegen.caihongy.cn/20250106/7db27eb0e39349b8b771cf620e80d883.png) no-repeat center / 100% 100%","display":"flex","gap":"10px"}'>
				<div class="echarts1">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
						<div :style='{"fontSize":"18px","lineHeight":"24px","color":"#fff","textAlign":"left","background":"none","fontWeight":"500"}'>
							专业总分统计
						</div>
					</div>
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="hisyearscoreChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="hisyearscoreChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="hisyearscoreChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"padding":"15px","margin":"0 20px","flexWrap":"wrap","flexDirection":"row","flex":"auto","background":"url(http://codegen.caihongy.cn/20250106/7db27eb0e39349b8b771cf620e80d883.png) no-repeat center / 100% 100%","display":"flex","width":"0"}'>
				<!-- 统计 -->
				<div :style='{"alignContent":"center","padding":"0 0 20px 0","margin":"0","color":"#fff","alignItems":"center","background":"none","display":"flex","gap":"12px","width":"100%","fontSize":"14px","justifyContent":"space-evenly","height":"100px"}'>

					<div :style='{"padding":"0","margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250107/1f7eba19214f45b0927b3bd789f47556.png) no-repeat center / 100% 100%","flexDirection":"row","flex":"1 1 auto","display":"flex","width":"190px","position":"relative","justifyContent":"space-evenly","height":"78px","maxWidth":"240px"}'>
						<div :style='{"width":"43px","margin":"0 10px","background":"url(http://codegen.caihongy.cn/20250107/e407db36b663494fafda6bf3c65cc6cf.png) no-repeat ","flex":"none","display":"block","height":"43px"}'></div>
						<div :style='{"padding":"0","alignItems":"center","flexWrap":"wrap","flexDirection":"row","flex":"auto","display":"flex","width":"0","height":"auto"}'>
							<div :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"inherit","width":"100%","lineHeight":"24px","fontSize":"inherit","position":"relative","textOverflow":"ellipsis","height":"24px"}'>历年考研分数总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"18px","color":"rgb(52, 171, 255)","fontWeight":"bold","order":"20"}'>{{hisyearscoreCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts7">
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="hisyearscoreChart7" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts8">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<el-table id="hisyearscoreTable" :data="hisyearscoreList" border :stripe="true" :style='{"padding":"0","borderColor":"rgba(92,135,230,.3)","borderWidth":"0","background":"none","width":"100%","overflow-y":"scroll","borderStyle":"solid","height":"calc(100% - 36px)"}'>
						<el-table-column :resizable="true" :sortable="false" prop="specname" label="专业名称">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="speccode" label="专业代码">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="schoolname" label="院校名称">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="totalscore" label="总分">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="politics" label="政治">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="english" label="外语">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="specialone" label="专业课一">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="specialtwo" label="专业课二">
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"padding":"15px","flexWrap":"wrap","flexDirection":"column","background":"url(http://codegen.caihongy.cn/20250106/7db27eb0e39349b8b771cf620e80d883.png) no-repeat center / 100% 100%","display":"flex","gap":"10px","width":"25%"}'>
				<div class="echarts4">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
						<div :style='{"fontSize":"18px","lineHeight":"24px","color":"#fff","textAlign":"left","background":"none","fontWeight":"500"}'>
							专业课分数统计
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="hisyearscoreChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="hisyearscoreChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts6">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="hisyearscoreChart6" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
		...
		created() {
			this.$nextTick(()=>{
				...
				setTimeout(()=>{
					...
					this.hisyearscoreChat6();
					this.hisyearscoreChat7();
				},500)
			})
		},
		methods:{
			gethisyearscoreList() {
				...
				this.$http({
					...
					if (data && data.code === 0) {
						this.hisyearscoreList = data.data.list;
						let div = document.getElementById('hisyearscoreTable')
						var scrollTop = -1
						function move() {
							if (div){
						...
						this.hisyearscoreTimer = setInterval(move, 2000);
						div.addEventListener('mouseenter', e => {
							e.stopPropagation()
							clearInterval(this.hisyearscoreTimer);
						})
			...
			hisyearscoreChat6() {
				this.$nextTick(()=>{
					...
					var hisyearscoreChart6 = echarts.init(document.getElementById("hisyearscoreChart6"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							hisyearscoreChart6.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								hisyearscoreChart6.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			hisyearscoreChat7() {
				this.$nextTick(()=>{
					...
					this.$http({
						url: "group/hisyearscore/speccode",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							var option = {};
							this.wordclouds(pArray,'hisyearscoreChart7');
...
<style lang="scss" scoped>
	...
	.el-table /deep/ .el-table__body-wrapper tbody tr.el-table__row--striped td {
		background: rgba(52, 171, 255,0.1);
	}
	
	.el-table /deep/ .el-table__body-wrapper tbody tr:hover td {
				padding: 6px 0;
				color: #fff;
				background: rgba(52, 171, 255,0.2);
				border-color: rgba(92,135,230,.3);
				border-width: 0;
				border-style: solid;
				text-align: left;
